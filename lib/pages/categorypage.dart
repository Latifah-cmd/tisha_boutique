            ...
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  FadeInUp(duration: const Duration(milliseconds: 1500), child:  makeProduct(image: 'assets/images/jj.jpg', title: 'Jewery', price: '300\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1600), child:  makeProduct(image: 'assets/images/7.jpg', title: '', price: '200\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1700), child:  makeProduct(image: 'assets/images/imagesw.jpg', title: 'kanzus', price: '500\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1800), child:  makeProduct(image: 'assets/images/d.jpg', title: 'dresses', price: '300\$')),
                  FadeInUp(duration: const Duration(milliseconds: 1900), child:  makeProduct(image: 'assets/images/bb5.jpg', title: 'veils', price: '600\$')),
                ],
              ),
            )
          ],
